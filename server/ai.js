...
4. learn — THREE short, genuinely useful, NEW lessons. Lessons 1 and 2: help a senior operations leader (~10 yrs experience) grow, covering TWO DIFFERENT domains (rotate widely: sheets/data, product, finance, strategy, communication, automation, decision-making, personal effectiveness). Lesson 3 is ALWAYS people & team management — a practical leadership lesson for Ravi as the manager of his central team: coaching, 1:1s, feedback, delegation, expectation-setting, difficult conversations, building ownership, motivation, developing people, and managing teammates whose working style differs from his. Ground lesson 3 in his real team and the gaps he is working on (visibility, expectation, feedback, career). Each lesson: title, category ("sheets"|"product"|"management"|"finance"|"strategy"|"communication"|"automation"|"growth"|"people"), lesson (1-2 sentences: what it is + why it matters), example (a tiny concrete example tied to HIS ops/leadership/team world), try_this (one specific thing to try this week). Lesson 3 MUST use category "people". Prefer rare-but-high-leverage over basics. DO NOT repeat any already-taught topic: ${learnedTopics.length ? learnedTopics.join("; ") : "(none yet)"}.
...
Return ONLY valid JSON, no markdown fences, exactly this shape:
{
  ...
  "learn": [{"title","category","lesson","example","try_this"},{"title","category","lesson","example","try_this"},{"title","category":"people","lesson","example","try_this"}]
}`;

  const raw = await chat([{ role: "user", content: prompt }], "", 3600);
